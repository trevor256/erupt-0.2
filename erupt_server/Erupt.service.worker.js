...
const CACHE_NAME = "Erupt-cache";
const OFFLINE_URL = "Erupt.offline.html";
// Files that will be cached on load.
const CACHED_FILES = ["Erupt.html","Erupt.js","Erupt.wasm","Erupt.pck","Erupt.offline.html","Erupt.icon.png","Erupt.apple-touch-icon.png"];
